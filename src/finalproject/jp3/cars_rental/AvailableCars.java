...
//@XmlRootElement
//@NamedQueries({
//    @NamedQuery(name = "AvailableCars.findAll", query = "SELECT a FROM AvailableCars a"),
//    @NamedQuery(name = "AvailableCars.findById", query = "SELECT a FROM AvailableCars a WHERE a.id = :id")})
...
//        return "finalproject.jp3.cars_rental.AvailableCars[ id=" + id + " ]";
//    }
